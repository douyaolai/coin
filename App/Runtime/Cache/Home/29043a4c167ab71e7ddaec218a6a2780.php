...
<div id="main">
    <div class="login_tongyi">
        <h2 class="user"><?php echo ((isset($config["name"]) && ($config["name"] !== ""))?($config["name"]):"虚拟币"); ?>用户登录</h2>
		...
		<span class="note" id="birthmsg" style="color:red; margin:0;">
                ...
                <li class="forget" style="margin-bottom:0px;">
                    ...
                    <span style="margin-left:118px;">没有<?php echo ((isset($config["name"]) && ($config["name"] !== ""))?($config["name"]):"虚拟币"); ?>账号？<a href="<?php echo U('Reg/reg');?>" class="zhuce">注册一个</a></span>
                </li>
