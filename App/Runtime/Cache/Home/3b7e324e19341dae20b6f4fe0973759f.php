    ...
    <form class="ybc_userarea" id="ttttform" method="post" jump-url="<?php echo U('Reg/regSuccess');?>" action="<?php echo U('Reg/addReg');?>" onsubmit="return step2();">
        <div id="step1">
            ...
            <div class="ybc_user clearfix">
                ...
                <div class="ybc_hint left"><strong class="msg_i" id="email_msg">i</strong><span id="emailmsg">请输入邮箱，请确保和<span class="red">积分会员系统账号一致</span>，否则无法交易</span></div><!--默认 i class="msg_i"  正确class="msg_error"  错误class="msg_ok"-->
            </div>
            <div class="ybc_user clearfix">
            ...
            <div class="ybc_user clearfix">
                ...
                <div class="left" style="color:#f00; line-height:30px;"></div>
            </div>
            <div class="ybc_user clearfix">
                <div class="ybc_label left"><label>&nbsp;</label></div>
