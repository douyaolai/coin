        ...
        <div class="buysell sellform">
          <div class="buyformarea left">
            ...
            <ul class="buyform">
              <li>
                <label>最佳买价：</label>
                <h3 id="coinbuy_nice" class="buy left"><?php echo ((isset($sell_record[count($sell_record)-1]['price']) && ($sell_record[count($sell_record)-1]['price'] !== ""))?($sell_record[count($sell_record)-1]['price']):"0.000"); ?></h3> <p>&nbsp;&nbsp;跌停：<?php echo ($pricedown); ?> 涨停：<?php echo ($priceup); ?></p>
              </li>
              <li>
          ...
          <div class="buyformarea right">
            ...
            <ul class="buyform sellform">
              <li>
                <label>最佳卖价：</label>
                <h3 id="coinsale_nice" class="sell left"><?php echo ((isset($buy_record[0]['price']) && ($buy_record[0]['price'] !== ""))?($buy_record[0]['price']):"0.000"); ?></h3> <p>&nbsp;&nbsp;跌停：<?php echo ($pricedown); ?> 涨停：<?php echo ($priceup); ?></p>
              </li>
              <li>
