                        ...
                        <table width="100%" class="insert-tab">
                            <tbody>
                              <tr>
                                ...
                                <tr>
                                    <th><i class="require-red">*</i>内盘转入开关：</th>
                                    <td><input type="text" id="" value="<?php echo ($config["trancoin_enable"]); ?>" size="85" name="trancoin_enable" class="common-text">设置是否允许内盘转入币,1允许，0禁止</td>
                                </tr>
                                <tr>
                                    <th></th>
                                    <td>
