            ...
            <form name="myform" id="myform" method="post">
                <div class="result-title">
                    <div class="result-list">
                        <a href="<?php echo U('Flash/add');?>"><i class="icon-font"></i>新增幻灯</a>
                    </div>
                </div>
                <div class="result-content">
                    <table class="result-tab" width="100%">
                        ...
                        <?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "$empty" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            <td><?php if(!empty($vo["pic"])): ?><img style=" width:400px; padding-left:120px;" src='<?php echo ($vo["pic"]); ?>' /><?php else: ?>暂无图片数据<?php endif; ?></td>
                            <td><?php echo ($vo["jump_url"]); ?></td>
                            <td><?php echo ($vo["title"]); ?></td>
                            <td><?php echo ($vo["sort"]); ?></td>
                            <td><?php echo (date("Y-m-d",$vo["add_time"])); ?></td>
                            <td>
                                <a class="link-update" href="<?php echo U('Flash/add',array('flash_id'=>$vo['flash_id']));?>">修改</a>
                                <a class="link-del" href="<?php echo U('Flash/del',array('flash_id'=>$vo['flash_id']));?>">删除</a>
                            </td>
