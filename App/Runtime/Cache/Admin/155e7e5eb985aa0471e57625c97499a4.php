    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                <form action="<?php echo U('Pending/index');?>" method="get">
                    ...
                    <table class="result-tab" width="100%">
                        <tr>
  						...
  						<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php echo ((isset($vo["bank_branch"]) && ($vo["bank_branch"] !== ""))?($vo["bank_branch"]):"暂未填写"); ?></td>
...
function download(){
	...
	var url="<?php echo U('Pending/derivedExcel');?>";
