    ...
    <div class="main-wrap">
        ...
        <div class="search-wrap">
            <div class="search-content">
                ...
                <form action="<?php echo U('Art/helpindex');?>" method="post" id="myform">
                        ...
                        <tr>
                            ...
                            <td>
                               ...
                               <select name="news_id" id="news_id">
                                  ...
                                  <?php if(is_array($category)): $i = 0; $__LIST__ = $category;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>" <?php if(($vo["id"]) == $inquire["news_id"]): ?>selected="selected"<?php endif; ?>> <?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                                </select>
                            </td>  
                            <th width="70">标题:</th>
        ...
        <div class="result-wrap">
                ...
                <div class="result-title">
                    <div class="result-list">
                    	<!--article_category_id传递文章类型id-->
                        <a href="<?php echo U('Art/insert',array('article_category_id'=>6));?>"><i class="icon-font"></i>新增文章</a>
                        <a href="<?php echo U('Arttype/insert');?>"><i class="icon-font"></i>新增帮助类别</a>
                    </div>
                </div>
                    ...
                    <table class="result-tab" width="100%">
                        <tr>
  						...
  						<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td>												
                                <a class="link-update" href="<?php echo U('Art/insert',array('article_id'=>$vo['article_id'],'article_category_id'=>$vo['parent_id']));?>">修改</a>
                                &nbsp;&nbsp;
...
<script>
$(".sub-menu").eq(7).show();
$(".sub-menu").eq(7).children("li").eq(2).addClass("on");
