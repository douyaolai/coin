        ...
        <div class="result-content">
            <table class="result-tab" width="100%">
                ...
                <tr>
                    ...
                    <td>网站开发</td>
                    <td><a target="_blank" href="http://wpa.qq.com/msgrd?v=3&uin=724446029&site=qq&menu=yes"><img border="0" src="/Public/Admin/images/QQ.png" alt="点击这里给我发消息" title="点击这里给我发消息"/></a></td>
                </tr>
                <tr>
                    <td>官网地址</td>
                    <td><?php echo $_SERVER['SERVER_NAME'];?></td>
