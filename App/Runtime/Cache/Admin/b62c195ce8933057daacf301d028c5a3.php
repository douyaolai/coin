...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="<?php echo U('Websitebank/addBank');?>" method="post" id="myform" name="myform" enctype="multipart/form-data">
                    ...
                    <table width="100%" class="insert-tab">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Websitebank/index');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
                        </tbody></table>
                </div>
