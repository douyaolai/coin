...
<div class="main-wrap">
	...
	<div class="result-wrap">
		<form action="<?php echo U('Fileconfigoperation/saveDbPrefix');?>" method="post" id="myform"
		...
		<form action="<?php echo U('Fileconfigoperation/saveDbPwd');?>" method="post" id="myform"
			name="myform" enctype="multipart/form-data">
			<div class="config-items">
				<div class="config-title">
					<h1>
