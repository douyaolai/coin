...
<div class="main-wrap">
	<div class="crumb-wrap">
		<div class="crumb-list">
			<i class="icon-font"></i><a href="<?php echo U('Index/index');?>">首页</a><span
				class="crumb-step">&gt;</span><span class="crumb-name">管理员充值</span>
		</div>
	</div>
	...
	<div class="result-wrap">
		...
		<div style="float: left; width: 30%; margin-right: 20px;">
			...
			<form action="<?php echo U('Pay/admRecharge');?>" method="post" id="myform"
				name="myform"  >
							...
							<tbody>
								...
								<tr>
									...
									<td><select name="currency_id" id="category">
											...
											<?php if(is_array($currency)): foreach($currency as $key=>$vo): ?><option value="<?php echo ($vo["currency_id"]); ?>"><?php echo ($vo["currency_name"]); ?></option><?php endforeach; endif; ?>
									</select></td>
		...
		<div style="float: left; width: 65%;">
            ...
            <div class="search-content">
				<form action="<?php echo U('Pay/admRecharge');?>" method="get">
					<table class="search-tab">
						<tr>
							...
							<th width="70">用户邮箱:</th>
							<td><input class="common-text" placeholder="用户邮箱" name="email" value="<?php echo ($get["email"]); ?>" id="" type="text"></td>
                            <th width="70">用户ID:</th>
			...
			<table class="result-tab" width="100%">
				...
				<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
					...
					<td><?php echo (getMemberEmailByMember_id($vo['member_id'])); ?></td>
...
<script>
$(".sub-menu").eq(4).show();
$(".sub-menu").eq(4).children("li").eq(4).addClass("on");
</script>