...
<div class="main-wrap">
    ...
    <div class="result-wrap">
        <form action="<?php echo U('Currency/set_member_currencyForQianbao');?>" method="post" id="myform" name="myform">
            <div class="config-items">
                <div class="config-title">
                    <h1><i class="icon-font">&#xe00a;</i><?php echo ($currency["currency_name"]); ?></h1>
                </div>
                <div class="result-content">
                    <table width="100%" class="insert-tab">
                        <tbody>
                    	<?php if(!empty($currency)): ?><input type="hidden" name="cuid" value="<?php echo ($currency["currency_id"]); ?>"><?php endif; ?>
						  <tr>
                            <th><i class="require-red"></i>钱包余额：</th>
                            <td><span><?php echo ($currency["balance"]); ?></span></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="<?php echo U('Link/index');?>"><input type="button" value="返回"  class="btn btn6"></a>
                            </td>
                        </tr>
