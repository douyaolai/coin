            ...
            <div class="result-content">
                <table class="result-tab" width="100%">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                            ...
                            <td><?php if($vo['status'] == 1): ?>启用<?php endif; ?>
								<?php if($vo['status'] == 0): ?>禁用<?php endif; ?>
							
								</td>
                            <td>
                                <a class="link-update" href="<?php echo U('Link/add',array('id'=>$vo['id']));?>">修改</a>
                                <a class="link-del" href="<?php echo U('Link/del',array('id'=>$vo['id']));?>" onclick="return confirm('确确认删除吗？')">删除</a>
                            </td>
